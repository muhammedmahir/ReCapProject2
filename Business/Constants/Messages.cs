...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static List<Rental> FailUnAvailableCars { get; internal set; }
        public static string ListedOfUnAvailableCars { get; internal set; }
        public static string OutOfStock { get; internal set; }
    }
}